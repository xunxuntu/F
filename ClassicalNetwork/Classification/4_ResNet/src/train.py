...
# import torchvision.models.resnet 点击resnet可以查看resnet的相关信息
...
def main():
    ...
    data_transform = {
        ...
        "val": transforms.Compose([transforms.Resize(256),  # 将长宽比固定不动，最小边缩放到256
    ...
    # model_weight_path = "../workspace/resnet34-333f7ec4.pth"
    ...
    epochs = 3
    best_acc = 0.0
    save_path = '../workspace/my_resNet34_no_pre.pth'
